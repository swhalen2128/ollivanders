...
Examples =
{
	...
	fountain :
	{
		...
		positionBase     : new THREE.Vector3( -210 , -60, -210 ),
		...
		accelerationBase : new THREE.Vector3( -250, 0, 0 ),
		
		particleTexture : THREE.ImageUtils.loadTexture( 'Puff.png' ),

		angleBase               : 90,
		angleSpread             : 180,
		angleVelocityBase       : 90,
		angleVelocitySpread     : 360 * 4,
		
		sizeTween    : new Tween( [0, 1], [1, 6] ),
		opacityTween : new Tween( [2, 3], [1, 0] ),
		colorBase    : new THREE.Vector3(0.02, 0.99, 0.65),
	...
	{
		positionStyle  : Type.SPHERE,
		positionBase   : new THREE.Vector3( -180 , -50, -150 ),
		positionRadius : 2,
		...
		sizeTween    : new Tween( [0, 0.3, 1.2], [10, 140, .5] ),
